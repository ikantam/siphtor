...
P(a); this.o.a.style.cssText = a; O(this.g); O(this.h); O(this.j); O(this.o);
      ...
      let a = e || null,
        ...
        b.f += c.length; f && (b.j = f); let h,
          ...
          let l = c[h],
            n = k[l.c],
            r = b.a,
            x = l; r.g && w(r.f, [r.a.c('wf', x.c, K(x).toString(), 'loading')]); L(r, 'fontloading', x); r = null; X === null && (X = window.FontFace ? (x = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent)) ? parseInt(x[1], 10) > 42 : !0 : !1); X ? r = new Q(p(b.g, b), p(b.h, b), b.c, l, b.s, n) : r = new R(
            p(b.g, b), p(b.h, b), b.c, l, b.s, a,
            n,
          ); m.push(r);
  ...
  function ya(a) { if (a.a.length == 0) throw Error('No fonts to load!'); if (a.c.indexOf('kit=') != -1) return a.c; for (var b = a.a.length, c = [], d = 0; d < b; d++)c.push(a.a[d].replace(/ /g, '+')); b = `${a.c}?family=${c.join('%7C')}`; a.f.length > 0 && (b += `&subset=${a.f.join(',')}`); a.g.length > 0 && (b += `&text=${encodeURIComponent(a.g)}`); return b; } function za(a) { this.f = a; this.a = []; this.c = {}; }
  let Aa = {
        ...
        var g; var k = d[1]; g = []; if (k) {
          for (var k = k.split(','), h = k.length, m = 0; m < h; m++) {
            var l; l = k[m]; if (l.match(/^[\w-]+$/)) {
              var n = Da.exec(l.toLowerCase()); if (n == null)l = ''; else {
                l = n[2]; l = l == null || l == '' ? 'n' : Ca[l]; n = n[1]; if (n == null || n == '')n = '4'; else {
                  var r = Ba[n],
          ...
          g, d.length > 0 && (d = Aa[d[0]]) && (a.c[e] = d));
      }a.c[e] || (d = Aa[e]) && (a.c[e] = d); for (d = 0; d < f.length; d += 1)a.a.push(new H(e, f[d]));
    }
  } function Fa(a, b) { this.c = a; this.a = b; } const Ga = { Arimo: !0, Cousine: !0, Tinos: !0 }; Fa.prototype.load = function (a) {
    let b = new C(),
      c = this.c,
      d = new va(this.a.api, z(c), this.a.text),
      e = this.a.families; xa(d, e); const f = new za(e); Ea(f); A(c, ya(d), D(b)); F(b, () => { a(f.a, f.c, Ga); });
  }; function Ha(a, b) { this.c = a; this.a = b; }Ha.prototype.load = function (a) {
    let b = this.a.id,
  ...
  }; function Ia(a, b) { this.c = a; this.f = b; this.a = []; }Ia.prototype.load = function (a) {
    let b = this.f.id,
      c = this.c.m,
